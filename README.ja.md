...
- **[Linux.do](https://linux.do)** — 中国語の開発者・技術コミュニティ（Discourse）。メンバーとフィードバックが本ガイドの中国展開指針を形作りました。著者は Linux.do トラストレベル3 会員です。
- **Telegram OpenClaw 中文社区** — Telegram 上の OpenClaw 中国語コミュニティ、サポートと議論に感謝します。
